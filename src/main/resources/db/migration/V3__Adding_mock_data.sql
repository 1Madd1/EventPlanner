-- Insert Guests
INSERT INTO guest (id, first_name, last_name,email, phone_number) VALUES
('11111111-1111-1111-1111-111111111111', 'Alice', 'Alice', 'alice@example.com', '123456789'),
('22222222-2222-2222-2222-222222222222', 'Bob', 'Alice', 'bob@example.com', '234567891'),
('33333333-3333-3333-3333-333333333333', 'Charlie', 'Alice', 'charlie@example.com', '345678912'),
('44444444-4444-4444-4444-444444444444', 'Diana', 'Alice', 'diana@example.com', '456789123'),
('55555555-5555-5555-5555-555555555555', 'Eve', 'Alice', 'eve@example.com', '567891234'),
('66666666-6666-6666-6666-666666666666', 'Frank', 'Alice', 'frank@example.com', '678912345'),
('77777777-7777-7777-7777-777777777777', 'Grace', 'Alice', 'grace@example.com', '789123456');
